                    ...
                    EGD.findOne({
                        ...
                        async (err, data2) => {
                            ...
                            if (!data2) {
                                ...
                                ctx.moveTo(180 + 250 * Math.cos(0), 280 + 250 * Math.sin(0));

                                for (let side = 0; side < 7; side++) {
                                    ctx.lineTo(180 + 250 * Math.cos(side * 2 * Math.PI / 6), 280 + 250 * Math.sin(side * 2 * Math.PI / 6));
                                }
                                ...
                                ctx.drawImage(avatar, 10, 40, 400, 400);
