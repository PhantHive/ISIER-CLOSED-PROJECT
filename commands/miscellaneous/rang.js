                    ...
                    EGD.findOne({
                        ...
                        async (err, data2) => {
                            ...
                            if (!data2) {
                                ...
                                ctx.moveTo(180 + 150 * Math.cos(0), 180 + 450 * Math.sin(0));

                                for (let side = 0; side < 7; side++) {
                                    ctx.lineTo(180 + 450 * Math.cos(side * 2 * Math.PI / 6), 180 + 450 * Math.sin(side * 2 * Math.PI / 6));
                                }
                                ...
                                ctx.drawImage(avatar, 20, 40, 450, 450);
