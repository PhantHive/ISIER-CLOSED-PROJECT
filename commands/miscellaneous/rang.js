                    ...
                    EGD.findOne({
                        ...
                        async (err, data2) => {
                            ...
                            if (!data2) {
                                ...
                                ctx.moveTo(150 + 100 * Math.cos(0), 120 + 100 * Math.sin(0));

                                for (let side = 0; side < 7; side++) {
                                    ctx.lineTo(150 + 100 * Math.cos(side * 2 * Math.PI / 6), 120 + 100 * Math.sin(side * 2 * Math.PI / 6));
                                }
                                ...
                                ctx.drawImage(avatar, 40, 60, 150, 150);
