                    ...
                    EGD.findOne({
                        ...
                        async (err, data2) => {
                            ...
                            if (!data2) {
                                ...
                                ctx.moveTo(70 + 80 * Math.cos(0), 95 + 80 * Math.sin(0));

                                for (let side = 0; side < 7; side++) {
                                    ctx.lineTo(70 + 80 * Math.cos(side * 2 * Math.PI / 6), 95 + 80 * Math.sin(side * 2 * Math.PI / 6));
                                }
                                ...
                                ctx.drawImage(avatar, 20, 35, 150, 150);
