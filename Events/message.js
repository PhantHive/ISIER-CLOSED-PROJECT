...
module.exports = async(client, message) => {
    ...
    if (chaine.indexOf("dropbox") !== -1) {
        const dropboxChannel = client.channels.find(channel => channel.name === "🎓▶liens-et-ressources-utiles◀🎓");
    ...
    const infoChannel = client.channels.find(channel => channel.name === "⌨▶informatique◀⌨");
