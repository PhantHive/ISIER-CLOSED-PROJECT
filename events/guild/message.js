        ...
        collector.on('collect', message => {
            ...
            if ((message.content).toLowerCase() === ("ph121" || "mp ph121" || "miniprojet ph121" || "mini projet ph121")) {
                ...
                underCollector.on('collect', message => {
                    ...
                    //PENDULE PROJET
                    else if ((message.content).toLowerCase() === (/pendule|"projet pendule|mini projet pendule/i)) {
                        message.channel.startTyping()
                    ...
                    //CALORIMETRIE PROJET
                    else if ((message.content).toLowerCase() === (/projet calorimetrie|miniprojet calorimetrie|mp calorimetrie|tp calorimetrie|calorimetrie/i)) {
                        message.channel.startTyping()
                        message.reply("je t envoi ca de suite")
                        message.channel.send("```yaml\nAnnee 2018-2019- partager par: Zakaria et Jeremie => =>```")                             //1
                            .then(() => message.channel.send({files: ['./ressources/aero1Sources/ph12/calorimetrie/calorimetrie2019-Jeremie-Zakaria.pptx/']}))
