        ...
        collector.on('collect', message => {
            ...
            if ((message.content).toLowerCase().search((/ph121|mp ph121|miniprojet ph121|mini projet ph121/i))) {
                ...
                underCollector.on('collect', message => {
                    //COMETE PROJET
                    if ((message.content).toLowerCase().search((/comete|halley|comete halley|mini projet comète de Halley|comète de Halley|comète/i))) {
                    ...
                    //PENDULE PROJET
                    else if ((message.content).toLowerCase().search((/pendule|"projet pendule|mini projet pendule/i))) {
                        message.channel.startTyping()
                    ...
                    //CALORIMETRIE PROJET
                    else if ((message.content).toLowerCase().search((/projet calorimetrie|miniprojet calorimetrie|mp calorimetrie|tp calorimetrie|calorimetrie/i))) {
                        message.channel.startTyping()
                        message.reply("je t envoi ca de suite")
                        message.channel.send("```yaml\nAnnee 2018-2019- partager par: Zakaria et Jeremie => =>```")                             //1
                            .then(() => message.channel.send({files: ['./ressources/aero1Sources/ph12/calorimetrie/calorimetrie2019-Jeremie-Zakaria.pptx/']}))
